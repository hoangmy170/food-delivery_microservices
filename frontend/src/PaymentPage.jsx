    ...
    const handleConfirmPayment = async () => {
        ...
        try {
            if (selectedCardId === 'new') {
                if (!newCard.card_number || !newCard.card_holder) { toast.warning("Vui lòng nhập thông tin thẻ! 💳"); setProcessing(false); return; }
            ...
            navigate('/history');
        } catch (err) { console.error(err); toast.error("Lỗi thanh toán. Vui lòng thử lại."); } finally { setProcessing(false); }
    };
